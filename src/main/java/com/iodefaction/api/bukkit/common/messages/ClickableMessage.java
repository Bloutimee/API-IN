package com.iodefaction.api.bukkit.common.messages;
...
public class ClickableMessage {
    ...
    public ClickableMessage link(String link) {
        link(current, link);
        return this;
    }

    public ClickableMessage linkAll(String link) {
    ...
    private void link(TextComponent component, String link) {
